...
export const hi: Strings = {
  ...
  mode: {
    ...
    back: "घर",
    unreviewed:
      "यह एक शोध संग्रह से है, किसी बधिर व्यक्ति ने अभी जाँचा नहीं है। इसे मार्गदर्शन मानें, अंतिम शब्द नहीं।",
  },
  ...
  studio: {
    ...
    importDataset: "डेटासेट कीपॉइंट आयात करें",
    importedSummary: (s, e) => `${s} इशारे, ${e} टेक आयात हुए। जब तक कोई बधिर व्यक्ति पुष्टि न करे, ये अपुष्ट रहेंगे।`,

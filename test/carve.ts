...
console.log('model        span  covered  dropped  supports  added  pieces  decodes');
for (const m of MODELS) {
  ...
  console.log(
    m.id.padEnd(12), String(r.spanModules).padStart(4), `${(r.coverageFraction * 100).toFixed(0)}%`.padStart(8),
